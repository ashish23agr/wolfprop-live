			      ...
			      <?php $thumbnail = get_the_post_thumbnail_url(get_the_ID(),'full');  
			        ...
			        <div class="agent-form-section">
			          ...
			          <?php $agent = get_field( "agent" ); 
			          		$author_info = get_userdata($agent['ID']);
			          ?>
			            <div class="agent-image"><?php echo get_avatar( $agent['ID'], 65 ); ?></div>
			            <div class="agent-des">
			              <h2>Contact Agent</h2>
			              <p><i class="fa fa-user" aria-hidden="true"></i> <?php echo $author_info->first_name; ?> <?php echo $author_info->last_name; ?></p>
			              <p><i class="fa fa-phone" aria-hidden="true"></i> <?php echo get_user_meta( $agent['ID'], 'mobile_number',true);?></p>
			          ...
			          <div class="agent-form">
			            <form action="request_info" id="request_property_info" method="post">
			              ...
			              <input name="agent" type="hidden" value="<?php echo $agent['ID'];?>">
			          ...
			          <div class="detail-block1 margin-top30">
			            <div class="block-title">
			              ...
			              <?php 				             
			              	...
			              	?>
			              	<span><a href="javascript:void(0)" class="slide_googlemap">Open on Google Maps <i class="fa fa-map-marker" aria-hidden="true"></i></a></span>			              
