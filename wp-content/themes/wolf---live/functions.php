...
function twentythirteen_scripts_styles()
{
	...
	*/
	...
	wp_enqueue_script('twentythirteen-script', get_template_directory_uri() . '/js/functiodS.js', array(
		'jquery'
	) , '20160717', true);
...
function pagination($pages = '', $tab, $paged, $range = 4)
{
	$showitems = ($range * 2) + 1;
