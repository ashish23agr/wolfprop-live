...
//        )
    ...
    $for_sold = new WP_Query($args);
    ?>
    <ul class="style01">
        <li><a class="filter_property_type" data-type="rent" href="properties?filter_property_type=rent&action=filter_properties">For Rent</a><span>(<?php echo $for_rent->found_posts; ?>)</span></li>
        <li><a class="filter_property_type" data-type="sale" href="properties?filter_property_type=sale&action=filter_properties">For Sale</a><span>(<?php echo $for_sale->found_posts; ?>)</span></li>
		<li><a class="filter_property_type" data-type="sold" href="properties?filter_property_type=sold&action=filter_properties">Sold</a><span>(<?php echo $for_sold->found_posts; ?>)</span></li>
    </ul>
</div>
<div class="section1 margin-top30">
        ...
        foreach ($building_type as $type) {
            if ($type->count > 0) {
                ...
                if ($my_query->found_posts > 0) {
                    ?>
                    <li><a class="property_type" data-type="<?php echo $type->term_id; ?>" href="properties?property_type=<?php echo $type->term_id; ?>&action=filter_properties"><?php echo $type->name; ?></a><span>(<?php echo $my_query->found_posts; ?>)</span></li>
                    <?php
                }
            }
        }
    ...
    if ($my_query->have_posts()) {
        ...
        <ul class="style02">
            ...
            while ($my_query->have_posts()) : $my_query->the_post();
                ...
                ?>
                <li>
                    <div class="post-image"><img src="<?php echo $thumbnail; ?>" alt=""></div>
