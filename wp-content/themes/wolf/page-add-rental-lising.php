...
?>  
<form action="" method="post" id="rental-from-submission">
    ...
    <div class="row margin-top30">
      ...
      ?>
        ...
        <div class="rent-information margin-top50">
          ...
          <div class="row margin-top10">
            <div class="col-md-2 col-sm-12 col-xs-12">
              <label>Listing Rent: <span class="required">*</span></label>
            </div>
        ...
        <div class="listing-information width100 pull-left margin-top50">
          ...
          <div class="row margin-top10">
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 text-right">
              <label>Landlord Contact :<span class="required">*</span></label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12">
              <div class="custom-input">
...
<?php get_footer(); ?>
      ...
      var count = 0;
         ...
         $( function() {
            ...
            //  formdata.append('form_data',  jQuery('#rental-from-submission').serialize());
       ...
       jQuery(document).ready(function($) {
        ...
        jQuery("#rental-from-submission").validate({
          ignore: [],
          rules: {				
            'title': {
              required: true,
