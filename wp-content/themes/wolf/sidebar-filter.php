...
// Check if wp_postmeta table exists before querying
$table_name = $wpdb->prefix . 'postmeta';
$table_exists = $wpdb->get_var("SHOW TABLES LIKE '$table_name'") == $table_name;

if ($table_exists) {
    $query = "SELECT min(cast(meta_value as unsigned)) FROM {$table_name} WHERE meta_key='listing_price'";
    $min = $wpdb->get_var($query);
    $query = "SELECT max(cast(meta_value as unsigned)) FROM {$table_name} WHERE meta_key='listing_price'";
...
<form type="get" action="properties" name ="property_filter" id="property_filter">
  <div class="container">    
      <select class="selectbox" id="filter_property_type" name="filter_property_type">        
        <option value="all" <?php echo ($filter_property_type == "all") ? "selected" : ""; ?>>All</option>
      ...
      <select class="selectbox" name="area">
        <option value=" ">Areas</option>  
         <?php 
          	$selected ="";
          	if (!is_wp_error($neighborhood) && !empty($neighborhood)) {
      ...
      <label class="toggle_on"><i class="fa fa-cog" aria-hidden="true"></i> Advanced</label>
    ...
    <div class="advance-search row" <?php echo $style;?>>
      ...
      ?>
        <select class="selectbox" name="filter_building_type">
          ...
          <?php 
          	$selected ="";
          	if (!is_wp_error($building_type) && !empty($building_type)) {
