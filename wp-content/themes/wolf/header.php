...
<?php /* All styles and scripts are enqueued via wp_enqueue_scripts in functions.php */ ?>
<?php wp_head(); ?>
</head>
<body>
<header>
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-xs-12 social-section">
        <ul>
          ...
          <!-- Added new buttons -->
          <li class="custom-buttons">
           <a href="/fair-housing-disclosure/" class="btn btn-secondary custom-button" target="_blank">Fair Housing Disclosure</a>
           <a href="/standard-operating-procedure/" class="btn btn-secondary custom-button" target="_blank">Standard Operating Procedure</a>
          </li>
...
<?php /* navigation.js enqueued via functions.php */ ?> 
