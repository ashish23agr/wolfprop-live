...
?>
	...
	<div id="primary" class="content-area">
		<div id="content" class="site-content" role="main">
			  ...
			  <div class="container">
			    ...
			    <div class="propert-detail-section">
			      ...
			      <?php $thumbnail = get_the_post_thumbnail_url(get_the_ID(),'full');  
						...
						else if($property_photos && $property_photos[0]['photo']['url']){
			        ...
			        ?>
			          <ul>
			            ...
			            <?php if(!empty($address) && !empty($zip_code))
			        	{
							...
							$geocodeFromAddr = 'https://maps.googleapis.com/maps/api/geocode/json?address=' . $formattedAddr . '&sensor=false&key=' . $apiKey;
							...
							$latitude  = isset($output->results[0]->geometry->location->lat) ? $output->results[0]->geometry->location->lat : 0;
							$longitude = isset($output->results[0]->geometry->location->lng) ? $output->results[0]->geometry->location->lng : 0; 
							...
							if($latitude && $longitude){
								?>
								 <li><a href="javascript:void(0)" id="google_map_view" data-toggle="modal" data-target="#myModal"><i class="fa fa-map" aria-hidden="true"></i></a></li>
				           		 <li><a href="javascript:void(0)" id="street_map_view" data-toggle="modal" data-target="#myModal_street"><i class="fa fa-street-view" aria-hidden="true"></i></a></li>
								<?php
							}
							?>
			        ...
			        <div class="col-sm-8 col-xs-12">
			          ...
			          <div class="detail-block1 margin-top30">
			            ...
			            <?php 			            	
			            	...
			            	$heat = get_field('heat');
			            	$taxonomy = 'building-style'; // FIXED: undefined taxonomy
			            ...
			            <ul class="detail-style01">			              
			              ...
			              <li>
								...
								<span><?php echo (get_field('listing_date')) ? date('m/d/Y',strtotime(get_field('listing_date'))) : 'N/A';?></span>
							</li>
							<li>
								<label>Start Online :</label>
								<span><?php echo (get_field('start_online')) ? date('m/d/Y',strtotime(get_field('start_online'))) : 'N/A';?></span>
							</li>
			              <li>
			...
			<script type="text/javascript" src="https://maps.google.com/maps/api/js?key=<?php echo $apiKey; ?>" async defer></script>
			<script>
				function initialize(id,view=''){
							...
							if(lat && lng){
								...
								if(view == "street")
								{
									...
									var STREETVIEW_MAX_DISTANCE = 100; // maximum distance to search for Street View
