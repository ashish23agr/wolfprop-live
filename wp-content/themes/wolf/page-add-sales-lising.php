...
if (is_user_logged_in()) {
  ...
  if ('POST' == $_SERVER['REQUEST_METHOD']) {
    ...
    if (!isset($_POST['title'])) {
      ...
      $message = '<p>Please enter title.</p>';
    }
    ...
    if (!isset($_POST['neighbourhood'])) {
      ...
      $message .= '<p>Please select neighborhood.</p>';
    }
    if (isset($_POST['neighbourhood']) && empty($neighbourhood)) {
      $error = false;
    ...
    if ($error) {
      ...
      if ($pid) {
        $property_images = $_POST['fields']['property_images'];
        $acf_images = array();
        foreach ($property_images as $key => $images) {
          if ($images !== $feature_image_id) {
            $acf_images[] = array(
              'photo' => $images,
        ...
        update_field('property_photos', $acf_images, $pid);

        set_post_thumbnail($pid, $feature_image_id);
        $_SESSION['status'] = '<div class="alert alert-success">Your listing has been published successfully.</div>';

      } else {
        $_SESSION['status'] = '<div class="alert alert-danger">Listing could not save, please try again</div>';
      }
    } else {
      $_SESSION['status'] = '<div class="alert alert-danger">' . $message . '</div>';

    }
  }
  ?>
  <form action="" method="post" id="sale-from-submission">
        ...
        <div class="row margin-top30">
          ...
          <div class="col-md-9 col-sm-8 col-xs-12 listing-content">
            ...
            <div class="page-heading2">
              ...
              <img class="pull-right margin-top-30" src="<?php echo get_template_directory_uri(); ?>/images/sold.png"
                alt="">
            </div>
            <div class="property-location">
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-xs-12 margin-top10 text-right">
                  <a href="javascript:void(0)" class="btn-default btn-default-blue fileinput-exists selectall">Select
                    All</a>
                  <a href="javascript:void(0)" class="btn-default btn-default-blue fileinput-exists deselectall">Deselect
                    All</a>
                </div>
                    ...
                    foreach ($neighborhood as $index => $value) {
                      ...
                      <li>
                        <div class="checkbox-button">
                          <input type="checkbox" name="neighbourhood[]" value="<?php echo $value->term_id; ?>"
                            id="check<?php echo $index; ?>" />
                          <label for="check<?php echo $index; ?>"> <span class="fa-stack"> <i
                                class="circle-o fa-stack-1x"></i> <i class="circle fa-stack-1x"></i> </span>
                            <?php echo $value->name; ?> </label>
                        </div>
                      </li>
                    <?php } ?>
                  </ul>
                  <label style="display:none;" id="neighbourhood[]-error" class="error" for="neighbourhood[]"></label>
            ...
            <div class="property-detail margin-top50">
              ...
              <div class="row margin-top20">
                <div class="col-md-2 col-sm-12 col-xs-12">
                  <label>Lot Size (Sq Ft.) <span class="required">*</span></label>
                </div>
                <div class="col-md-5 col-sm-12 col-xs-12">
                  <div class="custom-input">
                ...
                <div class="col-md-2 col-sm-12 col-xs-12 text-right">
                  <label>Building Size (Sq Ft.) <span class="required">*</span></label>
                </div>
                <div class="col-md-2 col-sm-12 col-xs-12">
                  <div class="custom-input">
                  ...
                  <ul>
                    <li>
                      <div class="checkbox-button">
                        ...
                        <label for="check1000"> <span class="fa-stack"> <i class="circle-o fa-stack-1x"></i> <i
                              class="circle fa-stack-1x"></i> </span> Oil </label>
                      </div>
                    </li>
                    <li>
                      <div class="checkbox-button">
                        <input type="checkbox" name="fields[heat_source][]" value="Gas" id="check1001" />
                        <label for="check1001"> <span class="fa-stack"> <i class="circle-o fa-stack-1x"></i> <i
                              class="circle fa-stack-1x"></i> </span> Gas </label>
                      </div>
                    </li>
                    <li>
                      <div class="checkbox-button">
                        <input type="checkbox" name="fields[heat_source][]" value="Electric" id="check1002" />
                        <label for="check1002"> <span class="fa-stack"> <i class="circle-o fa-stack-1x"></i> <i
                              class="circle fa-stack-1x"></i> </span> Electric </label>
                      </div>
                    </li>
                    <li>
                      <div class="checkbox-button">
                        <input type="checkbox" name="fields[heat_source][]" value="Solar" id="check1003" />
                        <label for="check1003"> <span class="fa-stack"> <i class="circle-o fa-stack-1x"></i> <i
                              class="circle fa-stack-1x"></i> </span> Solar </label>
                      </div>
                    </li>
                    <li>
                      <div class="checkbox-button">
                        <input type="checkbox" name="fields[heat_source][]" value="Radiant" id="check1004" />
                        <label for="check1004"> <span class="fa-stack"> <i class="circle-o fa-stack-1x"></i> <i
                              class="circle fa-stack-1x"></i> </span> Radiant </label>
                      </div>
                    </li>
                    <li>
                      <div class="checkbox-button">
                        <input type="checkbox" name="fields[heat_source][]" value="Other" id="check1005" />
                        <label for="check1005"> <span class="fa-stack"> <i class="circle-o fa-stack-1x"></i> <i
                              class="circle fa-stack-1x"></i> </span> Other </label>
                      </div>
                    </li>
                  </ul>
                </div>
                ...
                <div class="col-sm-12 col-xs-12 margin-top10 property-location">
                  <ul>
                    ...
                    foreach ($parking as $index => $value) {
                      ...
                      <li>
                        <div class="checkbox-button">
                          <input type="checkbox" name="parking[]" value="<?php echo $value->term_id; ?>" class=""
                            id="check<?php echo $i; ?>" />
                          <label for="check<?php echo $i; ?>"> <span class="fa-stack"> <i class="circle-o fa-stack-1x"></i>
                              <i class="circle fa-stack-1x"></i> </span> <?php echo $value->name; ?> </label>
                        </div>
                      </li>
                      <?php $i++;
                    } ?>
                ...
                <div class="col-sm-12 col-xs-12 margin-top10 property-location">
                  <ul>
                    ...
                    foreach ($mls as $index => $value) {
                      ...
                      <li>
                        <div class="checkbox-button">
                          <input type="checkbox" name="mls_features[]" value="<?php echo $value->term_id; ?>"
                            id="check<?php echo $i; ?>" />
                          <label for="check<?php echo $i; ?>"> <span class="fa-stack"> <i class="circle-o fa-stack-1x"></i>
                              <i class="circle fa-stack-1x"></i> </span> <?php echo $value->name; ?> </label>
                        </div>
                ...
                <div class="col-sm-12 col-xs-12 margin-top10 property-location">
                  <ul>
                    ...
                    foreach ($basement as $index => $value) {
                      ...
                      <li>
                        <div class="checkbox-button">
                          <input type="checkbox" name="basement[]" value="<?php echo $value->term_id; ?>"
                            id="check<?php echo $i; ?>" />
                          <label for="check<?php echo $i; ?>"> <span class="fa-stack"> <i class="circle-o fa-stack-1x"></i>
                              <i class="circle fa-stack-1x"></i> </span> <?php echo $value->name; ?> </label>
                        </div>
                ...
                <div class="col-sm-12 col-xs-12 margin-top10 property-location">
                  <ul>
                    ...
                    foreach ($yard as $index => $value) {
                      ...
                      <li>
                        <div class="checkbox-button">
                          <input type="checkbox" name="yard[]" value="<?php echo $value->term_id; ?>"
                            id="check<?php echo $i; ?>" />
                          <label for="check<?php echo $i; ?>"> <span class="fa-stack"> <i class="circle-o fa-stack-1x"></i>
                              <i class="circle fa-stack-1x"></i> </span> <?php echo $value->name; ?> </label>
                        </div>
                ...
                <div class="col-sm-12 col-xs-12 margin-top10 property-location">
                  <ul>
                    ...
                    foreach ($amenities as $index => $value) {
                      ...
                      <li>
                        <div class="checkbox-button">
                          <input type="checkbox" name="amenities[]" value="<?php echo $value->term_id; ?>"
                            id="check<?php echo $i; ?>" />
                          <label for="check<?php echo $i; ?>"> <span class="fa-stack"> <i class="circle-o fa-stack-1x"></i>
                              <i class="circle fa-stack-1x"></i> </span> <?php echo $value->name; ?> </label>
                        </div>
            ...
            <div class="rent-information margin-top50">
              ...
              <div class="row margin-top10">
                <div class="col-md-2 col-sm-12 col-xs-12">
                  <label>Listing Price:<span class="required">*</span></label>
                </div>
              ...
              <div class="row margin-top10">
                <div class="col-md-2 col-sm-12 col-xs-12">
                  <label>Date Available: <span class="required">*</span></label>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-12">
                  <div class="custom-input">
            ...
            <div class="listing-information width100 pull-left margin-top50">
                  ...
                  <div class="custom-selectbox">
                    <select class="selectbox" name="fields[agent]">
                      ...
                      foreach ($authors as $author) {
                        ...
                        ?>
                        <option value="<?php echo $author->ID; ?>"><?php echo $author_info->first_name; ?>
                          <?php echo $author_info->last_name; ?></option>
                      <?php } ?>
                    </select>
              ...
              <div class="row margin-top20">
                ...
                <div class="col-md-3 col-sm-12 col-xs-12 text-right">
                  <label>Start Online: <span class="required">*</span></label>
                </div>
                <div class="col-md-3 col-sm-12 col-xs-12">
                  <div class="custom-input">
              ...
              <ul id="images_wrap">
                <li class="images_head">
                  <div class="attachment">Photo</div>
                  <div class="attachment">Feature</div>
              ...
              <div class="row margin-top20">
                ...
                <div class="col-md-12 col-xs-12 upload_form">
                  <div class="fileinput fileinput-new margin-top20" data-provides="fileinput">
                    <span class="btn btn-default btn-default-blue btn-file"><span>Choose Photo</span><input
                        type="hidden"><input type="file" name="images[]" id="images" accept="image/*" multiple></span>
  ...
  <script>
    ...
    jQuery(document).ready(function ($) {
      ...
      jQuery("#sale-from-submission").validate({
        ignore: [],
        rules: {
          'title': {
            required: true,
            noSpace: true,
            minlength: 0, // Minimum value allowed
            maxlength: 100 // Maximum value allowed
          ...
          'fields[listing_price]': {
            ...
            max: 9999999999 // Maximum value allowed

          },
          'fields[landlord_contact_#]': {
            required: true,
            noSpace: true,
            phoneGlobal: true,
          ...
          'fields[zip_code]': {
            ...
            minlength: 0, // Minimum value allowed
            maxlength: 10 // Maximum value allowed
          ...
          'excerpt': {
            ...
            minlength: 0, // Minimum value allowed
            maxlength: 150 // Maximum value allowed
          ...
          'content': {
            ...
            minlength: 0, // Minimum value allowed
            maxlength: 500 // Maximum value allowed
          ...
          'fields[landlord]': {
            ...
            minlength: 0, // Minimum value allowed
            maxlength: 50 // Maximum value allowed

          },
          'fields[showing_notes]': {
            required: false,
            noSpace: true,
        ...
        messages: {
          ...
          'fields[listing_price]': {
            required: "This is a required field",
            required: "This is a required field",
            currency: "Please enter valid input.",
            min: "Value must be greater than or equal to 0.", // Custom message for minimum value
            max: "Value must be less than or equal to 9999999999."
          },
          'fields[landlord_contact_#]': {
            required: "This is a required field",
          },
